...
import vaetc
from vaetc.evaluation.metrics.generation import fid_rec
import yaml
...
def fid_generation(model: vaetc.models.VAE, dataset: vaetc.data.utils.ImageDataset, batch_size: int = 64):
    ...
    features, transform = fid_rec.build_features_inception_v3()
    ...
    for x, t in tqdm(loader):
        ...
        fs_real += [fid_rec.features_batch(x , features, transform)]
        fs_gen  += [fid_rec.features_batch(xs, features, transform)]
